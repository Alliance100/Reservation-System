          ...
          if (initialLoadRef.current) {
            ...
            if (newOrders.length > 0) {
              ...
              const newItems = newOrders.map((o: any) => ({
                id: o._id,
                title: `New Reservation #${o._id.slice(-6).toUpperCase()}`,
                desc: `${o.user?.name || 'Guest'} booked ${o.items?.length || 1} item(s) • $${o.totalAmount}`,
                time: "Just now",
                read: false
              }));
        ...
        >
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-black text-emerald-300 text-sm">NEW RESERVATION ARRIVED!</h4>
          ...
          <div className="mt-3 pt-2 border-t border-emerald-800/60 flex justify-between items-center text-xs">
            <span className="text-emerald-300 font-bold">Click to view in dashboard</span>
          ...
          <div className="flex justify-between h-20">
            <div className="flex w-full items-center justify-between">
              <div className="shrink-0 flex items-center">
                <Link href="/supplier" className="flex items-center gap-2 group">
                  ...
                  <span className="text-2xl font-black text-gray-900 tracking-tighter">
                    ...
                    <span className="ml-2 text-xs font-bold uppercase tracking-wider bg-emerald-100 text-emerald-800 px-2 py-0.5 rounded-md">Supplier</span>
                  </span>
                </Link>
              </div>
                            ...
                            <div className="absolute right-0 mt-3 w-80 bg-white rounded-3xl shadow-2xl border border-gray-100 p-4 text-gray-800 z-50 animate-in fade-in zoom-in-95">
                              <div className="flex items-center justify-between pb-3 border-b border-gray-100 mb-3">
                                <div className="flex items-center gap-2">
                                  <span className="font-black text-gray-900 text-sm">Order Alerts</span>
                                  {unreadCount > 0 && (
                              ...
                              {notifications.length === 0 ? (
                                <div className="py-8 text-center text-gray-400">
                                  ...
                                  <p className="text-[10px] text-gray-400 mt-0.5">Incoming bookings will ping here live!</p>
                                </div>
                              ) : (
