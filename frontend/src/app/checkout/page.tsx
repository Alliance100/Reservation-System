        ...
        <div className="flex-1 px-4 py-12 sm:px-6 lg:px-20 xl:px-24 bg-white z-10">
          <div className="max-w-xl mx-auto">
            ...
            <form onSubmit={handleCheckout} className="space-y-8">
              ...
              {/* Step 2: Payment Details (Simulation) */}
              <section>
                <h2 className="text-xl font-black text-gray-900 mb-6 flex items-center gap-3">
                  <span className="w-8 h-8 rounded-full bg-gray-100 text-gray-500 flex items-center justify-center text-sm">2</span>
                  Payment <span className="text-xs font-medium text-emerald-600 bg-emerald-50 px-2 py-1 rounded-md ml-2">EcoPay Secured</span>
                </h2>
                <div className="p-6 border-2 border-emerald-500 bg-emerald-50/30 rounded-2xl relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-gray-600 mb-4">Real payment gateways will be integrated in Milestone 5. No real card is required right now.</p>
                    <div className="h-12 bg-white rounded-xl border border-gray-200 flex items-center px-4 text-gray-400">
                      •••• •••• •••• 4242
                    </div>
                  </div>
                </div>
